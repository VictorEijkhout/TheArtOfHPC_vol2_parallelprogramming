...
The \ac{ABI} immediately supports the following query functions:
\begin{itemize}
\item \indexmpidef{MPI_Abi_get_version}, returning
  the major and minor version
  (or \lstinline{-1} if not suported); and
\item \indexmpidef{MPI_Abi_get_info},
