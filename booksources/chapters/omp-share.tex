...
The \indexpragma{single} directive is to be used for sections
that are part of the control flow, since it has an implicit concluding barrier.
The \indexpragma{master} and \indexpragma{masked} directives are similar,
...
The \indexpragmadef{masked} and \indexpragmadef{master} directives
...
\begin{remark}
  The \indexpragma{masked} directive is new in \ompstandard{5.1}.
  The \indexpragma{master} directive is deprecated
...
The \indexpragma{masked} directive has a \indexclause{filter} clause,
