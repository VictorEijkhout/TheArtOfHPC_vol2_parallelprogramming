...
\hbox to 18pt{MPI_Neighbor_alltoallv_c (\hss} \\
 ...
 & sdispls & integer array (of length outdegree). Entry \mpicode{j} specifies the displacement (relative to \mpiarg{sendbuf}) from which to send the outgoing data to neighbor \mpicode{j} & $\left[ \begin{array}{ll}\mathtt{ const\ int[] }  \\ \mathtt{ MPI_Aint[]} \end{array} \right.$  & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\ [+3pt]
