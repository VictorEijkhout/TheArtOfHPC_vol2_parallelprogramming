...
\hbox to 18pt{MPI_Gatherv_init (\hss} \\
 ...
 & recvcounts & non-negative integer array (of length group size) containing the number of elements that are received from each process & const\ int[] & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\
 & displs & integer array (of length group size). Entry \mpicode{i} specifies the displacement relative to \mpiarg{recvbuf} at which to place the incoming data from process \mpicode{i} & const\ int[] & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\
