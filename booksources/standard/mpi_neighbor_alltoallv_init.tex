...
\hbox to 18pt{MPI_Neighbor_alltoallv_init_c (\hss} \\
 ...
 & sdispls & integer array (of length outdegree). Entry \mpicode{j} specifies the displacement (relative to \mpiarg{sendbuf}) from which send the outgoing data to neighbor \mpicode{j} & $\left[ \begin{array}{ll}\mathtt{ const\ int[] }  \\ \mathtt{ MPI_Aint[]} \end{array} \right.$  & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\ [+3pt]
 ...
 & rdispls & integer array (of length indegree). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{recvbuf}) at which to place the incoming data from neighbor \mpicode{i} & $\left[ \begin{array}{ll}\mathtt{ const\ int[] }  \\ \mathtt{ MPI_Aint[]} \end{array} \right.$  & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\ [+3pt]
