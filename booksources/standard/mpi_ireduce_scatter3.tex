...
\hbox to 18pt{MPI_Ireduce_scatter (\hss} \\
 ...
 & recvcounts & non-negative integer array specifying the number of elements in result distributed to each process. This array must be identical on all calling processes. & const\ int[] & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\
