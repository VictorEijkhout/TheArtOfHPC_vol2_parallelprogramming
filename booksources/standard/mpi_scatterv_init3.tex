...
\hbox to 18pt{MPI_Scatterv_init (\hss} \\
 ...
 & displs & integer array (of length group size). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{sendbuf}) from which to take the outgoing data to process \mpicode{i} & const\ int[] & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\
