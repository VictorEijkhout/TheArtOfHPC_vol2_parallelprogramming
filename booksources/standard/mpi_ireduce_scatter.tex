...
\hbox to 18pt{MPI_Ireduce_scatter_c (\hss} \\
 ...
 & recvcounts & non-negative integer array specifying the number of elements in result distributed to each process. This array must be identical on all calling processes. & $\left[ \begin{array}{ll}\mathtt{ const\ int[] }  \\ \mathtt{ MPI_Count[]} \end{array} \right.$  & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\ [+3pt]
