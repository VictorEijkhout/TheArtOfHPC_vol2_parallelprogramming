...
\hbox to 18pt{MPI_Reduce_scatter (\hss} \\
 ...
 & recvcounts & non-negative integer array (of length group size) specifying the number of elements of the result distributed to each process. & const\ int[] & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\
