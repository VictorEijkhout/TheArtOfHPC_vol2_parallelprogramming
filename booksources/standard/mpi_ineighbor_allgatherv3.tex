...
\hbox to 18pt{MPI_Ineighbor_allgatherv (\hss} \\
 ...
 & sendcount & number of elements sent to each neighbor & int & INTEGER  & IN \\
 ...
 & recvcounts & non-negative integer array (of length indegree) containing the number of elements that are received from each neighbor & const\ int[] & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\
 & displs & integer array (of length indegree). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{recvbuf}) at which to place the incoming data from neighbor \mpicode{i} & const\ int[] & INTEGER\discretionary{}{\kern10pt}{}(*)  & IN \\
