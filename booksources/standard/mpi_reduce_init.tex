...
\hbox to 18pt{MPI_Reduce_init_c (\hss} \\
 ...
 & count & number of elements in send buffer & $\left[ \begin{array}{ll}\mathtt{ int }  \\ \mathtt{ MPI_Count} \end{array} \right.$  & INTEGER  & IN \\ [+3pt]
 & datatype & datatype of elements of send buffer & MPI_Datatype & TYPE\discretionary{}{\kern10pt}{}(MPI_Datatype)  & IN \\
