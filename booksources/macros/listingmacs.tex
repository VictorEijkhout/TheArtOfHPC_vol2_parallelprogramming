...
%%\lstdefinelanguage{cpp}{
  ...
  morekeywords={
    ...
    % more
    source_location,current,to_underlying,as_const,layout_right,
...
\lstdefinelanguage{cuda}[]{cpp}{
  ...
  morekeywords={
    ...
    cudaMalloc,cudaMalloHost,cudaMallocManaged,
    cudaMemcpy,cudaMemset,cudaFree,
    cudaDeviceSynchronize,cudaGetErrorString,
    cudaMemcpyHostToDevice,cudaMemcpyDeviceToHost,cudaMemcpyDeviceToDevice,
    threadIdx,blockIdx,gridDim,blockDim,cudaSuccess,
    cudaError_t,
  },
}
