...
\lstdefinelanguage{cpp}{
  ...
  morekeywords={
    ...
    clamp,destroy_at,gcd,iter_swap,lcm,minmax,
    binary_search,equal_range,lower_bound,partition_point,pop_heap,push_heap,upperbound,
    make_heap,sort_heap,is_permutation,next_permutation,prev_permutation,
    copy_backward,move_backward,sample,
    copy,copy_n,destroy,destroy_n,fill,fill_n,for_each,for_each_n,generate,generate_n,
    move,replace,replace_copy,replace_copy_if,replace_if,reverse,reverse_copy,
    swap_ranges,transform,uninitalized_*,
    adjacent_find,count_if,equal,find,find_end,find_first_of,find_if,find_if_not,
    includes,inner_product,is_heap,is_heap_until,is_partitioned,is_sorted,is_sorted_until,
    lexicographical_compare,max_element,min_element,minmax_element,mismatch,none_of,
    reduce,search,search_n,exclusive_scan,inclusive_scan,
    ...
    forward_iterator_tag,input_iterator,sentinel_for,
...
\lstdefinelanguage{slurm}[]{shell}{
  keywordstyle=\bfseries\color{green},
  classoffset=2,
  morekeywords={
    sbatch,squeue,idev,ibrun,
  }
}
