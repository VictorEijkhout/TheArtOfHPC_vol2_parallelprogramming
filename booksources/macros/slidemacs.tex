...
\newenvironment
    ...
    {\def\optfile{#1}
      ...
      \fi
      \begin{frame}[containsverbatim]{Exercise \arabic{excounter} \tt{#1}}
...
\newcounter{subsectionframe}[sectionframe]
\OutlineLevelStart 0{\refstepcounter{sectionframe}
  \frame{\part{#1}\Large\bf \arabic{sectionframe}. #1}}
\OutlineLevelStart 1{\refstepcounter{subsectionframe}
  \frame{\section{#1}\large\bf \arabic{sectionframe}.\arabic{subsectionframe}. #1}}
