...
\makeindex[name=cuda,title=,columns=1]
...
% cuda
\newcommand\indexcudashow  {\PackageIndex\cudaIndexRM}
\newcommand\indexcudadef   {\PackageIndex\cudaIndexBF}
\newcommand\cudaIndexRM{\RoutineIndexFont{cuda}{textrm}\endgroup}
\newcommand\cudaIndexBF{\RoutineIndexFont{cuda}{textbf}\endgroup}
