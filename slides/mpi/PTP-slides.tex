...
\protoslide{MPI_Recv}
\begin{mpl}
  \mplprotoslide{MPI_Send}
  \mplprotoslide{MPI_Recv}
\end{mpl}
...
\begin{numberedframe}{Distributed data}
  ...
  \includegraphics[scale=.09]{mpi-array.png}
...
\end{itemize}
\hbox{
\includegraphics[scale=.07]{send-ideal}
\includegraphics[scale=.07]{send-blocking}
}
