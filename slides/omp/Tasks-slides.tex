...
\begin{numberedframe}{Task data space}
  \begin{itemize}
  \item Private data of the parallel region is
    captured as \lstinline{firstprivate}
...
\begin{numberedframe}{Task data: tricky exception}
  Shared data of the parallel region is shared in the task;
  if you want \lstinline{firstprivate}, specify explicitly:
\begin{lstlisting}
...
\begin{numberedframe}{Complicated dependencies}
...
\begin{lstlisting}
#pragma omp task depend(in:x[1:n-1) depend(out:y[:m])
\end{lstlisting}
\end{numberedframe}
