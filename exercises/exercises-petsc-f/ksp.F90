...
!!  call MatView(A,PETSC_VIEWER_STDOUT_WORLD,ierr)
  ...
  call VecDuplicate(Rhs,Sol,ierr); CHKERRA(ierr)
  call VecSet(Rhs,one,ierr); CHKERRA(ierr)
  ...
  call KSPGetPC(Solver,Prec,ierr); CHKERRA(ierr)
  call PCSetType(Prec,PCJACOBI,ierr); CHKERRA(ierr)
  ...
  !!
  call KSPSolve(Solver,Rhs,Sol,ierr); CHKERRA(ierr)
...
10   format("Converged in",I5," iterations.\n")
  ...
  call VecDestroy(Sol,ierr); CHKERRA(ierr)
