...
! %%%%
! %%%% lockfetchshared.F90 : passive target synchronization & atomic update
! %%%%
! %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
! %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Program LockFetchShared
  use :: mpi_f08
  use :: iso_c_binding
  use :: posix
  implicit none
  ...
  !!
  call MPI_Win_lock(MPI_LOCK_SHARED,repo,assert,the_window)
  if (procno==supervisor) then
     !!
...
!!!! your code here !!!!
     ...
     do 
        ...
        call MPI_Win_flush_local(repo,the_window)
        if (readout<=0) exit
        my_work = my_work+1
