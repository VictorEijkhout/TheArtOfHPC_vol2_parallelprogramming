...
if (len(sys.argv) != 2):
	...
	print >> sys.stderr, "  Will generate a linear_<num hosts>.xml and hostfile_<num hosts>.txt file\n"
	exit(1)

num_hosts = int(sys.argv[1])

###############################################################
# Generate LINEAR XML file
filename = "./linear_"+str(num_hosts)+".xml"
fh = open(filename, 'w')
fh.write(issueHead())
...
fh.write(issueTail())
fh.close()
print >> sys.stderr, "Linear XML platform file created: "+filename
